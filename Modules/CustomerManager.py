...
class Customer:
    ...
    def __init__(self, profile):
        ...
        # optional
        self.__diagnosis_and_adjustment_of_transparency = None
...
class CustomerManager:
    ...
    def update_profile_cust(self, customer_name, new_profile):
        ...
        if self.add_cust(new_profile, old_customer[1]) is not None:  # The new profile included a new customer name
            ...
            return True
            # if self.remove_cust(old_customer[0]):
            #     return True
            # else:
            #     return "remove old customer Error!"
    ...
    def __check_profile_dictionary(profile):
        list_profile_keys = ["first name", "last name", "parent name", "phone", "address", "Email", "referred by",
                             "reason for referral"]
